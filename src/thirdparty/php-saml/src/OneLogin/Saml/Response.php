...
class OneLogin_Saml_Response
{
    ...
    public function getAttributes()
    {
        ...
        $attributes = array();
		$_attributeValueFormat = array(
			'saml:attributevalue', //For SAML generated response XML -- Keep it all lowercase
			'attributevalue'       //For ADFS 2.0 generated response XML -- Keep it all lowercase
		);
        ...
        foreach ($entries as $entry) {
            ...
            foreach ($entry->childNodes as $childNode) {
				if (in_array(strtolower($childNode->tagName), $_attributeValueFormat)) {
